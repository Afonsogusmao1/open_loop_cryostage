...
from code_simulation.optimization.open_loop_problem import build_reference_profile_from_theta, load_front_csv
from code_simulation.optimization.open_loop_workflow_config import build_problem_config


def _configure_matplotlib() -> None:
    configure_matplotlib(plt, figure_size=(8.8, 4.8))
