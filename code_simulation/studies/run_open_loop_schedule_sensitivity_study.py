...
from code_simulation.studies.common import (
    bounds_arg as _theta_bounds_arg,
    theta_arg as _theta_arg,
    write_empty_best_theta_csv as _write_empty_best_theta_csv,
)
...
def _structural_prescreen_message(config, theta_bounds_C: tuple[tuple[float, float], ...]) -> str | None:
    ...
    constraints = load_reachability_constraints(default_constraints_dir())
...
def main(argv: list[str] | None = None) -> None:
    ...
    study_settings = {
        ...
        "scope_note": "comparison support only; the active single-run workflow is code_simulation.optimization.run_open_loop_optimization",
